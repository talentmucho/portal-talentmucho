...
const SESSION = {
  ...
  description:
    "All three outputs from the bootcamp — your Claude.ai Projects, your AI employee, and your Claude Code dashboard — run together in a real workflow. We'll identify exactly where Claude fits in your workday and draft your daily routine.",
  resources: [
    { label: "Full stack integration guide", href: "#" },
          ...
          <div className="rounded-2xl border border-[var(--beige-200)] dark:border-white/5 bg-white dark:bg-[var(--card)] p-5 flex items-center justify-between gap-4 mt-auto">
            <div>
              <p className="text-sm font-medium text-[var(--charcoal-900)] dark:text-foreground">
                Up next: Showcases, Q&amp;A, and graduation
              </p>
              <p className="text-xs text-[var(--taupe-400)] font-light mt-0.5">
                Week 4 · Session 8 — Sun, Jun 28
              </p>
            </div>
            <Link
              href={NEXT}
