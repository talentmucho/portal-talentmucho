...
const SESSION = {
  ...
  description:
    "Every participant gets 5 minutes to share what they built. Then we close with open Q&A, a look at what comes next, and your graduation from Cohort 1.",
  resources: [
    { label: "Showcase template", href: "#" },
    { label: "Graduation resources", href: "#" },
    { label: "What's next guide", href: "#" },
  ],
};

const OVERVIEW = "/participant/courses/cohort-1";
const PREV     = "/participant/courses/cohort-1/session-9";
    ...
    <div className="h-screen bg-[var(--beige-50)] dark:bg-background flex flex-col overflow-hidden">
      ...
      <div className="flex-1 flex flex-col lg:flex-row overflow-hidden">
        ...
        <main className="flex-1 flex flex-col p-6 md:p-8 gap-6 min-w-0 overflow-y-auto">
          ...
          {/* Week deliverable callout */}
          <div className="rounded-2xl border border-[var(--beige-200)] dark:border-white/5 bg-[var(--beige-100)] dark:bg-[var(--card)] p-5">
