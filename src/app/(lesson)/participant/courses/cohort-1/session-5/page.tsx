...
const SESSION = {
  ...
  description:
    "An introduction to AI employees — what they are, what the Cowork platform makes possible, and how real businesses are using them today. We'll see a live demo and you'll leave with a clear plan for what you're building in Session 4.",
  resources: [
    { label: "Cowork platform overview", href: "#" },
    { label: "AI employee examples", href: "#" },
          ...
          <div className="rounded-2xl border border-[var(--beige-200)] dark:border-white/5 bg-white dark:bg-[var(--card)] p-5 flex items-center justify-between gap-4 mt-auto">
            <div>
              <p className="text-sm font-medium text-[var(--charcoal-900)] dark:text-foreground">
                Up next: Build and test your first AI employee live
              </p>
              <p className="text-xs text-[var(--taupe-400)] font-light mt-0.5">
                Week 2 · Session 4 — Sun, Jun 14
              </p>
            </div>
            <Link
              href={NEXT}
